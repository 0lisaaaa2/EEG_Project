...
"""
Compute t-tests for hypothesis 1, hypothesis 2 (2A and 2B), and calculate Cohen's dz effect sizes. Also plot SPN amplitudes with confidence intervals.
"""
...
def run_statistics(spn_front_values, perspective_cost_values, alpha):
    ...
    res3 = stats.ttest_1samp(perspective_cost_values, -0.35e-6, alternative="greater") 
...
# effect size cohens dz for paired samples
...
def plot_spn_amplitude(grand_avg_cost, grand_avg_front, grand_avg_perp, all_subject_cost, all_subject_front, all_subject_perp, alpha=0.02):
    ...
    means = [grand_avg_front * 1e6, grand_avg_perp * 1e6, grand_avg_cost * 1e6] 
