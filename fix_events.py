...
"""
Extract events from the raw data status channel and save them in a tsv file with correct annotations for each subject and task.
If not already in events.tsv, run this script to get correct event annotations for the rest of the pipeline.
"""
